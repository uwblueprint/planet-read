...
class FirebaseRestClient:
    ...
    # docs: https://cloud.google.com/identity-platform/docs/use-rest-api#section-sign-in-with-oauth-credential
    def sign_in_with_google(self, id_token):
        """
        Obtain user's personal info, access token, and refresh token from Google.
